...
namespace WebAPI.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(WebAPIContext context) //Injeção de dependência -> Ao ser criado recebe uma instância do context
        {
            _context = context;
        }
        ...
        public void Seed() 
        {
            ...
            _context.Department.AddRange(d1, d2, d3, d4); //Adiciona vários objetos de uma vez no banco
